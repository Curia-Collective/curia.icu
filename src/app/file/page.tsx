    ...
    <div className="relative w-full h-screen flex justify-center items-center">
      ...
      <div className="relative z-10 bg-white p-3 rounded-2xl text-center border border-8 border-black">
        ...
        <div className="flex flex-col md:flex-row text-3xl mt-8 space-y-4 md:space-y-0 md:space-x-8">
          <a href="https://canny.nani.ooo/curia" target="_blank" rel="noopener noreferrer" className="bg-yellow-400 text-black px-4 py-2 rounded-lg border-black border-4 hover:shadow-neon-yellow">📤 Submit</a>
          ...
          <a href="https://opensea.io/collection/judgments-1" target="_blank" rel="noopener noreferrer" className="bg-red-500 text-black px-4 py-2 border-black border-4 rounded-lg hover:shadow-neon-red">💼 Cases</a>
        </div>
